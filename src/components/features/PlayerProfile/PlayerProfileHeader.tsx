...
export function PlayerProfileHeader({ profile, stats }: PlayerProfileHeaderProps) {
  ...
  return (
    <>
      ...
      />
      <div className="bg-gradient-to-br from-wefit-dark to-wefit-dark-muted border border-white/5 rounded-2xl p-8 shadow-2xl">
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
          ...
          <div className="relative">
            {profile.avatar_url ? (
              ...
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gradient-to-br from-wefit-gold to-yellow-600 flex items-center justify-center ring-4 ring-wefit-gold/50">
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between">
              <div>
                <h1 className="text-3xl md:text-4xl font-bold text-wefit-white mb-2">
                ...
                {profile.bio && (
                  <p className="text-wefit-grey max-w-2xl mb-4">{profile.bio}</p>
                )}
              </div>
              ...
              {isOwnProfile && (
                <button
                  ...
                  className="px-4 py-2 bg-wefit-primary hover:bg-wefit-primary-hover text-white rounded-lg transition-colors flex items-center gap-2"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-wefit-dark-muted/50 border border-white/5 rounded-lg p-4">
              ...
              <div className="bg-wefit-dark-muted/50 border border-white/5 rounded-lg p-4">
                ...
                <div className="text-2xl font-bold text-wefit-white">{stats?.matches_played || 0}</div>
              </div>
